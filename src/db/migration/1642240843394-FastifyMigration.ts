...
export class FastifyMigration1642240843394 implements MigrationInterface {
    name = 'FastifyMigration1642240843394'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "task_entity" ADD CONSTRAINT "FK_ab0e8bfc5d1eec5eab1f616d4e0" FOREIGN KEY ("boardId") REFERENCES "board_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
